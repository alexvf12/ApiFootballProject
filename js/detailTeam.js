...
async function addStatsTeam() {
  try {
    ...
    const contentContainer = document.createElement("div"); // Contenedor para las estadísticas y jugadores
    ...
    playersContainer.style.display = "none"; // Ocultar jugadores inicialmente
